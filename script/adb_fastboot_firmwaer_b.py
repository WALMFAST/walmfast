...
def set_A():
	...
	if platform.system() == 'Linux':
		try:
			if os.system(f'fastboot set_active a 2> infolog/partition.txt') == 0:
				return True
			else:
				return False
		except:
		...
		try:
			if os.system(fr'{os.getcwd()}\\platform-tools-windows\\platform-tools\\fastboot set_active a 2> infolog/partition.txt') == 0:
				return True
			else:
				return False
		except:
...
def set_B():
	...
	if platform.system() == 'Linux':
		try:
			if os.system(f'fastboot set_active b 2> infolog/partition.txt') == 0:
				return True
			else:
				return False
		except:
		...
		try:
			if os.system(fr'{os.getcwd()}\\platform-tools-windows\\platform-tools\\fastboot set_active b 2> infolog/partition.txt') == 0:
				return True
			else:
				return False
		except:
