...
q_start_flash_recovery_process= ['Reboot device to recovery?', 'Reboot phone. its longer but wait.', 'Cheking for Unlocked bootloader', 'Flashing', 'Recovery flashing Succeful complete!\nWhere restart?', 'Cant reboot', 'Recovery flashing error.\nCheck File or Device connection.']
recovery = 'Recovery'
system = 'System'
score = 'Results:'
yes = 'Yes'
...
flash_gsi = 'flash GSI'
gsi_process_hader = ['Reboot your phone into fastbootd mode?', 'Reboot. The system will be flashed in 30 seconds. \nPress and hold the volume + button during reboot', 'In 15 seconds the system firmware will start.', 'Start of system firmware. Bootloader check', 'Bootloader unlocked. Flash phone', 'GSI flash process was successful\nWhere to reboot?', 'An error occurred in the flash GSI.\nCheck the file or the connection between your phone and PC.']
