...
approve_custom_load = 'Allow custom boot'
...
q_start_flash_recovery_process= ['Reboot device to recovery?', 'Rebootin phone. its longer but wait.', 'Cheking for Unlocked bootloader', 'Flashing', 'Recovery flashing Succeful complete!\nWhere restart?', 'Cant reboot', 'Recovery flashing error.\nCheck File or Device connection.']
recovery = 'Recovery'
system = 'System'
score = 'Results:'
yes = 'Yes'
